(function (global, factory) {
    ...
    (global = global || self, global.Forms = factory());
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		m(target, anchor, remount) {
    			...
    			dispose = [
    				action_destroyer(getValues_action = getValues.call(null, form)),
    				listen(form, "update", /*update_handler*/ ctx[2])
    			];
    		},
    		p(ctx, [dirty]) {
    			if (default_slot) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [$$scope, $$slots, update_handler];
    }
